...
@Component({
  moduleId: module.id,
  selector: 'other-calendar-component',
  templateUrl: 'other-calendar.component.html',
  styleUrls: [ 'other-calendar.component.css']
})

export class OtherCalendarComponent implements OnInit {
  constructor(
  ...
  registerAvailability(val: any):void {
    ...
    let returnObj = {'tilTid': (date1 + '23:00:00'), 'fraTid': (date2 + '24:00:00'), 'userId': 1};
    console.log(returnObj);
    this.shiftService.addAvailability(returnObj);
